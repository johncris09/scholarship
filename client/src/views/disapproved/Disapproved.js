      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          ...
          <CTabContent>
            ...
            >
              <hr />
              <ManageApplication app_status="disapproved" scholarship_type="senior_high" />
            </CTabPane>
            <CTabPane
              role="tabpanel"
            ...
            >
              <hr />
              <ManageApplication app_status="disapproved" scholarship_type="college" />
            </CTabPane>
            <CTabPane
              role="tabpanel"
            ...
            >
              <hr />
              <ManageApplication app_status="disapproved" scholarship_type="tvet" />
            </CTabPane>
          </CTabContent>
        </CCardBody>
      </CCard>
